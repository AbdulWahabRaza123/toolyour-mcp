...
export const SKILL_WORKFLOW_MAP: Record<string, string> = {
  ...
  "site-agent-readiness": "site-agent-readiness-job",
  "accessibility-audit": "accessibility-audit-job",
  "website-health-check": "website-health-check-job",
  "indexability-audit": "indexability-audit-job",
  "local-seo-audit": "local-seo-audit-job",
  "fix-verify-indexability": "indexability-audit-job",
  "mcp-discovery-audit": "mcp-discovery-audit-job",
  "soft-404-audit": "soft-404-audit-job",
  "pagination-seo-audit": "pagination-seo-audit-job",
  "eeat-signals-audit": "eeat-signals-audit-job",
  ...
  "production-readiness-gate": "ship-gate-job",
  ...
  "fix-verify-site-agent-readiness": "site-agent-readiness-job",
